...
alias q='exit'
alias na='nautilus'
alias rsg='killall -SIGQUIT gnome-shell'
alias rsfc='fc-cache -f -v'
alias wgup='wg-quick up vpn76-se-sto'
alias wgdown='wg-quick down vpn76-se-sto'
